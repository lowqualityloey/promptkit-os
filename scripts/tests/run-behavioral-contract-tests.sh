...
assert_contains "templates/agent-directive-template.md" "parallel batch counts per call" "Balanced breaker defines parallel-call counting"
assert_contains "templates/agent-directive-template.md" "trivial edits never reset" "Balanced breaker excludes trivial-edit resets"
assert_contains "templates/agent-directive-template.md" "Read-only needs no edit" "Balanced breaker covers read-only research"
...
assert_contains "templates/agent-directive-lite-template.md" "Read-only needs no edit" "Lite breaker covers read-only research"
