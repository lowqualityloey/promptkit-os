...
- **Telemetry Status Cards**: Emit the 3-line card per `$KIT_DIR_REL/protocols/telemetry-cards.md` (lazy-load on demand); halts still use `[!IMPORTANT]` / `[!WARNING]` callouts.
