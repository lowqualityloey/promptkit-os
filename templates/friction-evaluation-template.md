...
- **Scenario Set [Required]**: `L0 | Minimal Controlled | Full Controlled | TDD-enabled | CI failure`; record `N/A` only with a reason.
...
- **Minimal Planning rule**: Required planning inputs must be no more than `3`: requested outcome, observable completion condition, and scope boundary. Existing Controlled Work readiness remains separate.
...
| Minimal Controlled Work | [Three-input planning path] | [0-3] | [Record sections, not duplicate workflow] | [Result] | [Result] | [Pass / result] | [Result] | [Result] | [Result] | [Evidence] |
| Full Controlled Work | [Full trigger and existing RFC path] | [Result] | [Result] | [Result] | [Result] | [Pass / result] | [Result] | [Result] | [Result] | [Evidence] |
