...
- **Balanced (official, default)** — full 23 workflows, 2,449 tok static, Level 0-3 adaptive ceremony, teams/production
...
| **Static tokens** | 1,105 tok | 2,449 tok | 2,449 tok + subagents |
