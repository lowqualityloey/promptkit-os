...
- **Balanced (official, default)** — full 23 workflows, 2,103 tok static, Level 0-3 adaptive ceremony, teams/production
...
| **Static tokens** | 877 tok | 2,103 tok | 2,103 tok + subagents |
...
- Balanced directive: 8,413 chars → 2,103 tok (89% reduction)
