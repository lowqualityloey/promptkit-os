...
- **Lite (official)** — 6 utility workflows, 1,059 tok static (measured), 80% value, onboarding
- **Balanced (official, default)** — full 23 workflows, 2,496 tok static, Level 0-3 adaptive ceremony, teams/production
...
| **Static tokens** | 1,059 tok | 2,496 tok | 2,496 tok + subagents |
