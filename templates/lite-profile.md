...
- **Balanced (official, default)** — full 23 workflows, 2,401 tok static, Level 0-3 adaptive ceremony, teams/production
...
| **Static tokens** | 1,079 tok | 2,401 tok | 2,401 tok + subagents |
